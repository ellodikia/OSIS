...
if(isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO kegiatan (tanggal, judul, waktu, lokasi, penanggung_jawab, deskripsi) 
              VALUES ('$tanggal', '$judul', '$waktu', '$lokasi', '$penanggung_jawab', '$deskripsi')";
...
<head>
    ...
    <title>Tambah Kegiatan | Admin Raksana</title>
            ...
            <header class="h-16 border-b border-slate-800 bg-slate-900/50 flex items-center justify-between px-4 md:px-8 sticky top-0 z-20 backdrop-blur-md">
                <div class="flex items-center gap-4">
                    ...
                    <h1 class="text-xs md:text-sm font-medium text-slate-400 uppercase tracking-widest">
                        Kelola Kalender <span class="mx-2 text-slate-600">/</span> <span class="text-white">Tambah Kegiatan</span>
                    </h1>
                </div>
            </header>
            ...
            <div class="p-4 md:p-8 lg:p-12 flex justify-center">
                <div class="w-full max-w-4xl">
                    <div class="border-l-4 border-red-700 bg-slate-900/20 p-6 md:p-10">
                        <div class="mb-10">
                            <h2 class="text-3xl font-black text-white tracking-tighter uppercase italic">Form Input Agenda</h2>
                            <p class="text-slate-500 text-sm mt-1 uppercase tracking-tighter">Organisasi Raksana • Tahun 2025</p>
                        </div>
                        ...
                        <form action="" method="POST" class="space-y-8">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="judul" required placeholder="Masukkan nama agenda..." 
                                ...
                                <div>
                                    ...
                                    <input type="text" name="lokasi" required placeholder="Tempat kegiatan..." 
                                        class="w-full bg-slate-900/50 border border-slate-800 px-4 py-3 rounded-xl text-white focus:outline-none focus:border-red-600 transition-all">
                                </div>

                                <div>
                                    <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mb-3">Penanggung Jawab</label>
                                    <input type="text" name="penanggung_jawab" required placeholder="Nama Koordinator..." 
                                        class="w-full bg-slate-900/50 border border-slate-800 px-4 py-3 rounded-xl text-white focus:outline-none focus:border-red-600 transition-all">
                                </div>

                                <div class="md:col-span-2">
                                    <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mb-3">Deskripsi Singkat</label>
                                    <textarea name="deskripsi" rows="4" required placeholder="Tuliskan detail poin-poin kegiatan..." 
                                        class="w-full bg-slate-900/50 border border-slate-800 px-4 py-3 rounded-xl text-white focus:outline-none focus:border-red-600 transition-all resize-none"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="pt-10 flex flex-col md:flex-row items-center gap-4">
                                <button type="submit" name="submit" 
                                    ...
                                    <i class="fa-solid fa-check-double mr-3"></i> Simpan Agenda
                                </button>
